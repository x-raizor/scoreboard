...
public class Board {
    ...
    private static final String FONTNAME = "AlicoreStencils-Regular.otf"; // doesn't work for now, we have to generate font via createFont Tool
    private static final int    PHWIDTH = 54, PHHEIGHT = 64,
                                XMARGIN = 10, YMARGIN = 10,
                                PHUPPERHALF = 32, PHBOTTOMHALF = 29, GAP = 3,
                                BASELINE = 56, 
                                FONTSIZE = 65, // doesn't work for now, we have to generate font via createFont Tool
    ...
    public Board(PApplet context, String[] text) {
        ...
        PFont captions = ctx.loadFont("AlicoreStencils-Regular-65.vlw");
    ...
    private PGraphics createSymbol(char symbol) {
        ...
        buffer.textFont(ctx.loadFont("AlicoreStencils-Regular-65.vlw"));
